...
productRouter.put("/product/:id", upload.array('product_pict'), isAuth, ProductController.updateProduct); // update terbitkan

productRouter.post("/product-preview",  upload.array('product_pict'), isAuth, ProductController.previewProduct);
